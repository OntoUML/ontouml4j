...
/**
 * A named element that represents an element of the language's abstract syntax (e.g., a class, a relation, or a
 * generalization).
 */
...
public abstract class ModelElement extends NamedElement {
  /**
   * Determines custom properties of the model element using key-value pairs. In UML, for instance, this custom
   * properties are represented through tagged values.
   */
