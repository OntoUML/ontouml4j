...
import org.ontouml.ontouml4j.serialization.BinaryRelationSerializer;
...
public class BinaryRelation extends Relation {
  ...
  public static BinaryRelation createRelation(
      String id, String name, Classifier<?, ?> source, Classifier<?, ?> target) {
    return new BinaryRelation(id, name, source, target);
  }

  public static BinaryRelation createMaterial(
      String id, String name, Classifier<?, ?> source, Classifier<?, ?> target) {
    return new BinaryRelation(id, name, RelationStereotype.MATERIAL, source, target);
  }
  ...
  public static BinaryRelation createComparative(
      String id, String name, Classifier<?, ?> source, Classifier<?, ?> target) {
    return new BinaryRelation(id, name, RelationStereotype.COMPARATIVE, source, target);
  }

  public static BinaryRelation createDerivation(
      String id, String name, Classifier<?, ?> source, Classifier<?, ?> target) {
    return new BinaryRelation(id, name, RelationStereotype.DERIVATION, source, target);
  }

  public static BinaryRelation createDerivation(Classifier<?, ?> source, Classifier<?, ?> target) {
