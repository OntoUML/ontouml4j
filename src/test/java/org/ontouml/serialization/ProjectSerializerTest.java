...
import static org.ontouml.utils.BuilderUtils.*;
...
public class ProjectSerializerTest {
  ...
  void beforeEach() throws URISyntaxException, JsonProcessingException {
    ...
    Map<String, org.ontouml.model.Class> classes = createClasses();

    generalizations.forEach(
        (key, item) -> {
          org.ontouml.model.Class general = classes.get("class_1");
